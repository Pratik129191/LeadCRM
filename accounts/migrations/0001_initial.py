    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('SALES', 'Sales Member')], db_index=True, default='SALES', max_length=20)),
                ('joined_at', models.DateTimeField(auto_now_add=True)),
                ('is_active_member', models.BooleanField(db_index=True, default=False)),
